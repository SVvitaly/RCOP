...
gem 'refinerycms-news', '~> 3.0', :git => 'https://github.com/refinery/refinerycms-news'

gem 'refinerycms-calendar', '~> 3.0', :git => 'https://github.com/refinery/refinerycms-calendar'
